...
import { getVineflower } from '../java/vineflower';
import type { MappingType } from '../types/minecraft';
import { ClassNotFoundError } from '../utils/errors';
import { logger } from '../utils/logger';
import { classNameToPath, getDecompiledPath } from '../utils/paths';
import { getRemapService } from './remap-service';
